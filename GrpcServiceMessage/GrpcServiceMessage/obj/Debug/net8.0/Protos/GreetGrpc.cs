...
namespace GrpcServiceMessage {
  public static partial class MessageBroker
  {
    ...
    public abstract partial class MessageBrokerBase
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::GrpcServiceMessage.Message> Subcribirse_Cliente(global::GrpcServiceMessage.ClientRequest request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, MessageBrokerBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_Subcribirse_Cliente, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GrpcServiceMessage.ClientRequest, global::GrpcServiceMessage.Message>(serviceImpl.Subcribirse_Cliente));
